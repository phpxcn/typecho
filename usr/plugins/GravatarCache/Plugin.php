 ...
 * 使用方法：即插即用
 */
class GravatarCache_Plugin implements Typecho_Plugin_Interface
{
    /**
    ...
    {
        Typecho_Plugin::factory('Widget_Abstract_Comments')->gravatar = array('GravatarCache_Plugin', 'getGravatar');
    }
     ...
     * @return bool
     */
	private static function download($url, $referer, $imagePath)
	{
